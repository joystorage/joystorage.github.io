$(function(){
    ...
    $("#myphoto").append(pages);
     ...
     var pages='<ul class="photo_ul">'+
    		'<h1>北京</h1><br/><br/><p></p>'+
			'<li class="photo_li"><div class="img-box"><a class="img-bg" rel="example_group" href="/photos/北京1.jpg"></a><img class="img-img1" src="/photos/北京1.jpg" /></div></li>'+
    ...
    $("#myphoto").append(pages);
     ...
     var pages='<ul class="photo_ul">'+
			...
			'<li class="photo_li"><div class="img-box"><a class="img-bg" rel="example_group" href="/photos/深圳1.jpg"></a><img class="img-img1" src="/photos/深圳1.jpg" /></div></li>'+
    ...
    $("#myphoto").append(pages);
     ...
     var pages='<ul class="photo_ul">'+
			...
			'<li class="photo_li"><div class="img-box"><a class="img-bg" rel="example_group" href="/photos/长春1.jpg"></a><img class="img-img1" src="/photos/长春1.jpg" /></div></li>'+
