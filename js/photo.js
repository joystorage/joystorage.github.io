$(function(){
    ...
    $("#myphoto").html(pages);
     ...
     var pages='<ul class="photo_ul">'+
			...
			'<li class="photo_li"><div class="img-box"><img class="img-img1" lazy-src="/photos/1.jpg" /></div></li>'+
        	'<li class="photo_li"><div class="img-box"><img class="img-img1" src="/photos/2.jpg" /></div></li>'+
            '<li class="photo_li"><div class="img-box"><img class="img-img1" lazy-src="/photos/3.jpg" /></div></li>'+
            '<li class="photo_li"><div class="img-box"><img class="img-img1" lazy-src="/photos/4.jpg" /></div></li>'+
            '</ul><br/>';
    ...
    $("#myphoto").append(pages);
        ...
        var pages='<ul class="photo_ul">'+
        	...
        	'<li class="photo_li"><div class="img-box"><img class="img-img1" lazy-src="/photos/厦门4.jpg" /></div></li>'+
            '</ul><br/><br/><br/>';
    $("#myphoto").append(pages);
